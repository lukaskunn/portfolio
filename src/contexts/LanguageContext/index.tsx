...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
    ...
    const [currentLanguage, setCurrentLanguage] = useState(languages[language as keyof typeof languages]);
    ...
    return (
        <LanguageContext.Provider value={{ language, setLanguage, currentLanguage, changeLanguage }}>
            {children}
