...
const AboutSection = ({ content, sectionSubTitle }: AboutSectionType) => {
  ...
  useEffect(() => {
    setHoverImportantText(aboutBackgroundIsHover || aboutMeIsHover || aboutTitleIsHover)
  ...
  return (
    <section className={styles.container}>
      <div className={styles.about} id={"about"}>
        ...
        <div className={`${styles.about__right} about-container`} ref={aboutContainerRef}>
          <div className='title-container'>
            <h1 ref={aboutTitleRef} dangerouslySetInnerHTML={{ __html: sectionSubTitle }} className={`${styles["about-title"]} about-title`} />
          </div>
          ...
          <section className={styles.about__right__background} ref={aboutBackgroundRef}>
